...
export const getCBBTeamLogo = (teamName) => {
  ...
  const foundPartial = Object.keys(teamLogos).find(key => {
    ...
    // Avoid short keys matching incorrectly (e.g. "Ohio" matching "Ohio State")
    if (lowerKey.length <= 4) return lowerTeam === lowerKey;
    return lowerTeam.includes(lowerKey) || lowerKey.includes(lowerTeam);
  });
